    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 drop-shadow-lg">Welcome to ShopMart</h1>
          <p className="text-lg md:text-xl max-w-2xl drop-shadow-md">
            Experience shopping like never before. Sign in or create your account today!
          </p>
        </div>
      </section>
      ...
      <div className="flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <Card className="w-full max-w-md mx-auto lg:mx-0 shadow-xl border border-gray-200">
